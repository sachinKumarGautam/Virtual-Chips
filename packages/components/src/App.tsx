                ...
                >
                    ...
                    <View style={styles.body}>
                        ...
                        <View style={styles.sectionContainer}>
                            ...
                            <Text style={styles.sectionDescription}>
                                It will share the same code from mobile, unless
                                you create platform-specific files using the{" "}
                                <Text style={styles.highlight}>.web.tsx</Text>{" "}
                                extension (also supports{" "}
